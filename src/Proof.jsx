      ...
      <section className="max-w-7xl mx-auto w-full px-margin md:px-margin-tablet lg:px-margin-desktop pt-8 pb-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6">
          <div className="flex flex-col gap-3">
            ...
            <h1 className="font-headline-lg text-headline-lg md:text-[48px] md:leading-[54px] text-text-primary tracking-tight font-semibold max-w-2xl">
              Coding isn't just a skill, it's a habit.
            </h1>
          </div>
            ...
            <div>
              ...
              <div className="flex items-start justify-between pb-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="font-headline-md text-headline-md text-text-primary font-semibold tracking-tight">GitHub Activity</h2>
            ...
            <div>
              ...
              <div className="flex items-start justify-between pb-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="font-headline-md text-headline-md text-text-primary font-semibold tracking-tight">LeetCode Activity</h2>
                      <span className="w-2 h-2 rounded-full bg-accent"></span>
                    </div>
        ...
        <div className="bg-surface rounded-xl p-6 md:p-8 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center justify-between pb-6 gap-4">
            <div>
              ...
              <h2 className="font-headline-md text-headline-md text-text-primary font-semibold tracking-tight mt-1">Daily Habit & Code Principles</h2>
            </div>
